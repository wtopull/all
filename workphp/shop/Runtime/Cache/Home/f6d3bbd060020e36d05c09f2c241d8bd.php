        ...
        <div class="layui-tab layui-tab-card">
          ...
          <div class="layui-tab-content" style="">
            <div class="layui-tab-item layui-show">
              <form class="layui-form" action="/shop/index.php/Home/Index/index.html" enctype="multipart/form-data">
                <div class="layui-form-item layui-row"> <label class="layui-form-label">图片</label>
                  <div class="layui-input-block"> 
                  	<input type="file" name="img_bg" class="layui-col-xs2 layui-col-sm2" id="test1" style="margin-top:5px;">
										</input>
                  </div>
                </div>
                <div class="layui-form-item layui-row"> <label class="layui-form-label">标题</label>
                  <div class="layui-input-block"> <input type="text" name="title_bg" required lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input layui-col-xs11 layui-col-sm11"> </div>
                </div>
                <div class="layui-form-item"> <label class="layui-form-label">文本域</label>
                  <div class="layui-input-block">
                    <script type="text/plain" id="myEditor" style="width:92%;height:300px;" name="script">
                      <p name="text_bg"></p>
                    </script>
                  </div>
                </div>
                <div class="layui-form-item">
                  <div class="layui-input-block"> <button class="" type="submit">立即提交</button> <button type="reset" class="layui-btn layui-btn-primary">重置</button> </div>
                </div>
              </form>
            </div>
