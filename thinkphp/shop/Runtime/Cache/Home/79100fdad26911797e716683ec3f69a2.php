    ...
    <body>
        ...
        <div class="header_bg">
            ...
            <form id="searchForm" method="get" >
                ...
                <input name="imageField" value=" " class="go" style="cursor: pointer; background: url('/shop/Public/images/sousuo.gif') no-repeat scroll 0% 0% transparent; width: 39px; height: 20px; border: medium none; float: left; margin-right: 15px; vertical-align: middle;" type="submit" />
            </form>
        </div>
        <div class="blank5"></div>
        <div class="header_bg_b">
            <div class="f_l" style="padding-left: 10px;">
                <img src="/shop/Public/images/biao6.gif">
                    北京市区，现在下单(截至次日00:30已出库)，<b>明天上午(9-14点)</b>送达 <b>免运费火热进行中！</b>
            </div>
            <div class="f_r" style="padding-right: 10px;">
                <img style="vertical-align: middle;" src="/shop/Public/images/biao3.gif">
                    ...
                    <div class="box_1">
                        ...
                        <div class="boxCenterList clearfix" id="history_list">
                            <ul class="clearfix">
                                <li class="goodsimg">
                                    <a href="#" target="_blank">
                                        <img src="/shop/Public/images/8_thumb_G_1241425513488.jpg" alt="飞利浦9@9v" class="B_blue" />
                                    </a>
                                </li>
                                <li>
                            ...
                            <ul class="clearfix">
                                <li class="goodsimg">
                                    <a href="#" target="_blank">
                                        <img src="/shop/Public/images/9_thumb_G_1241511871555.jpg" alt="诺基亚E66" class="B_blue" />
                                    </a>
                                </li>
                                <li>
            ...
            <div class="AreaR">
                ...
                <div id="show_best_area" class="clearfix">
                    <div class="goodsItem">
                        ...
                        <a href="#"><img src="/shop/Public/images/9_thumb_G_1241511871555.jpg" alt="诺基亚E66" class="goodsimg"></a><br />
                    ...
                    <div class="goodsItem">
                        ...
                        <a href="#"><img src="/shop/Public/images/8_thumb_G_1241425513488.jpg" alt="飞利浦9@9v" class="goodsimg"></a><br />
                    ...
                    <div class="goodsItem">
                        ...
                        <a href="#"><img src="/shop/Public/images/17_thumb_G_1241969394587.jpg" alt="夏新N7" class="goodsimg"></a><br />
                    ...
                    <div class="box_1">
                        <h3>
                            ...
                            <form method="GET" class="sort" name="listform">
                                显示方式：
                                <a href="#"><img src="/shop/Public/images/display_mode_list.gif" alt=""></a>
                                <a href="#"><img src="/shop/Public/images/display_mode_grid_act.gif" alt=""></a>
                                <a href="#"><img src="/shop/Public/images/display_mode_text.gif" alt=""></a>&nbsp;&nbsp;

                                <a href="#"><img src="/shop/Public/images/goods_id_DESC.gif" alt="按上架时间排序"></a>
                                <a href="#"><img src="/shop/Public/images/shop_price_default.gif" alt="按价格排序"></a>
                                <a href="#"><img src="/shop/Public/images/last_update_default.gif" alt="按更新时间排序"></a>
                        ...
                        <form name="compareForm" action="compare.php" method="post" onsubmit="return compareGoods(this);">
                            <div class="clearfix goodsBox" style="border: medium none; padding: 11px 0pt 10px 5px;">
                                <div class="goodsItem">
                                    <a href="#"><img src="/shop/Public/images/32_thumb_G_1242110760196.jpg" alt="诺基亚N85" class="goodsimg"></a><br />
                                    <p><a href="#" title="诺基亚N85">诺基亚N85</a></p>
                                    <font class="market_s">￥3612元</font><br />
                                    <font class="shop_s">￥3010元</font><br />
                                    <a href="#"><img src="/shop/Public/images/goumai.gif"></a> &nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="#"><img src="/shop/Public/images/shoucang.gif"></a>
                                </div>
                                <div class="goodsItem">
                                    <a href="#"><img src="/shop/Public/images/24_thumb_G_1241971981429.jpg" alt="P806" class="goodsimg"></a><br />
                                ...
                                <div class="goodsItem">
                                    <a href="#"><img src="/shop/Public/images/22_thumb_G_1241971076803.jpg" alt="多普达Touc..." class="goodsimg"></a><br />
                                ...
                                <div class="goodsItem">
                                    <a href="#"><img src="/shop/Public/images/21_thumb_G_1242109298150.jpg" alt="金立 A30" class="goodsimg"></a><br />
                                ...
                                <div class="goodsItem">
                                    <a href="#"><img src="/shop/Public/images/20_thumb_G_1242106490058.jpg" alt="三星BC01" class="goodsimg"></a><br />
                                ...
                                <div class="goodsItem">
                                    <a href="#"><img src="/shop/Public/images/19_thumb_G_1241970175208.jpg" alt="三星SGH-F..." class="goodsimg"></a><br />
                                ...
                                <div class="goodsItem">
                                    <a href="#"><img src="/shop/Public/images/13_thumb_G_1241968002527.jpg" alt="诺基亚5320..." class="goodsimg"></a><br />
                                ...
                                <div class="goodsItem">
                                    <a href="#"><img src="/shop/Public/images/12_thumb_G_1241965978410.jpg" alt="摩托罗拉A81..." class="goodsimg"></a><br />
                                ...
                                <div class="goodsItem">
                                    <a href="#"><img src="/shop/Public/images/10_thumb_G_1242973436403.jpg" alt="索爱C702c" class="goodsimg"></a><br />
        ...
        <div id="bottomNav" class="box block">
            <div class="box_1">
                <div class="links clearfix"> 
                    <a href="#" target="_blank" title="YONGDA商城"><img src="/shop/Public/images/category.htm" alt="YONGDA商城" border="0"></a>
