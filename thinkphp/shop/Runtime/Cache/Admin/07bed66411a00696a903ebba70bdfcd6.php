      ...
      <td valign=top align=middle>
        ...
        <table id=child1 style="display: none" cellspacing=0 cellpadding=0 width=150 border=0>
          <tr height=20>
            ...
            <td>
              <a class=menuchild href="#" target='_top'>公司简介</a>
            </td>
          </tr>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
            <td>
              <a class=menuchild href="#" target='_top'>荣誉资质</a>
            </td>
          </tr>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
            <td>
              <a class=menuchild href="#" target='_top'>分类管理</a>
            </td>
          </tr>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
            <td>
              <a class=menuchild href="#" target='_top'>子类管理</a>
            </td>
          </tr>
          <tr height=4>
            <td colspan=2></td>
        ...
        <table id=child2 style="display: none" cellspacing=0 cellpadding=0 width=150 border=0>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
            <td>
              <a class=menuchild href="#" target='_top'>公司新闻</a>
            </td>
          </tr>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
        ...
        <table id=child3 style="display: none" cellspacing=0 cellpadding=0 width=150 border=0>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
            <td>
              <a class=menuchild href="/shop/index.php/Admin/Goods/showlist" target='right'>产品展示</a>
            </td>
          </tr>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
            <td>
              <a class=menuchild href="#" target='_top'>最新产品</a>
            </td>
          </tr>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
        ...
        <table cellspacing=0 cellpadding=0 width=150 border=0>
          <tr height=22>
            <td style="padding-left: 30px" background=<?php echo ADMIN_IMG_URL; ?>menu_bt.jpg>
              <a class=menuparent onclick=expand(4) href="javascript:void(0);">客户服务</a>
            </td>
          </tr>
          <tr height=4>
            <td></td>
        ...
        <table id=child4 style="display: none" cellspacing=0 cellpadding=0 width=150 border=0>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
            <td>
              <a class=menuchild href="#" target='_top'>客户服务</a>
            </td>
          </tr>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
        ...
        <table cellspacing=0 cellpadding=0 width=150 border=0>
          <tr height=22>
            <td style="padding-left: 30px" background=<?php echo ADMIN_IMG_URL; ?>menu_bt.jpg>
              <a class=menuparent onclick=expand(5) href="javascript:void(0);">经典案例</a>
            </td>
          </tr>
          <tr height=4>
            <td></td>
        ...
        <table id=child6 style="display: none" cellspacing=0 cellpadding=0 width=150 border=0>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
            <td>
              <a class=menuchild href="#" target='_top'>广告管理</a>
            </td>
          </tr>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
            <td>
              <a class=menuchild href="#" target='_top'>访问统计</a>
            </td>
          </tr>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
            <td>
              <a class=menuchild href="#" target='_top'>邮件发送设置</a>
            </td>
          </tr>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
            <td>
              <a class=menuchild href="#" target='_top'>联系部门</a>
            </td>
          </tr>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
            <td>
              <a class=menuchild href="#" target='_top'>用户留言</a>
            </td>
          </tr>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
            <td>
              <a class=menuchild href="#" target='_top'>招聘职位</a>
            </td>
          </tr>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
            <td>
              <a class=menuchild href="#" target='_top'>应聘人员</a>
            </td>
          </tr>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
            <td>
              <a class=menuchild href="#" target='_top'>留言簿</a>
            </td>
          </tr>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
            <td>
              <a class=menuchild href="#" target='_top'>产品订购</a>
            </td>
          </tr>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
            <td>
              <a class=menuchild href="#" target='_top'>链接管理</a>
            </td>
          </tr>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
            <td>
              <a class=menuchild href="#" target='_top'>文件管理</a>
            </td>
          </tr>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
            <td>
              <a class=menuchild href="#" target='_top'>信息转移</a>
            </td>
          </tr>
          <tr height=4>
            <td colspan=2></td>
        ...
        <table id=child7 style="display: none" cellspacing=0 cellpadding=0 width=150 border=0>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
            <td>
              <a class=menuchild href="#" target='_top'>基本设置</a>
            </td>
          </tr>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
            <td>
              <a class=menuchild href="#" target='_top'>样式管理</a>
            </td>
          </tr>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
            <td>
              <a class=menuchild href="#" target='_top'>栏目管理</a>
            </td>
          </tr>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
            <td>
              <a class=menuchild href="#" target='_top'>功能管理</a>
            </td>
          </tr>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
            <td>
              <a class=menuchild href="#" target='_top'>菜单管理</a>
            </td>
          </tr>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
            <td>
              <a class=menuchild href="#" target='_top'>首页设置</a>
            </td>
          </tr>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
            <td>
              <a class=menuchild href="#" target='_top'>管理员列表</a>
            </td>
          </tr>
          <tr height=4>
            <td colspan=2></td>
        ...
        <table id=child0 style="display: none" cellspacing=0 cellpadding=0 width=150 border=0>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
            <td>
              <a class=menuchild href="#" target='_top'>修改口令</a>
            </td>
          </tr>
          <tr height=20>
            <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL; ?>menu_icon.gif" width=9></td>
