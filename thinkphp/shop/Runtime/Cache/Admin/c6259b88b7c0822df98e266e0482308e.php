...
<link href="<?php echo ADMIN_CSS_URL; ?>/admin.css" type="text/css" rel="stylesheet" /> </head>
<body>
  <table cellspacing=0 cellpadding=0 width="100%" align=center border=0>
    <tr height=28>
      <td background=<?php echo ADMIN_IMG_URL; ?>title_bg1.jpg>当前位置: </td>
    </tr>
    <tr>
      <td bgcolor=#b1ceef height=1></td>
    </tr>
    <tr height=20>
      <td background=<?php echo ADMIN_IMG_URL; ?>shadow_bg.jpg></td>
    </tr>
  </table>
  ...
  <table cellspacing=0 cellpadding=0 width="95%" align=center border=0>
    ...
    <tr height=22>
      <td style="padding-left: 20px; font-weight: bold; color: #ffffff" align=middle background=<?php echo ADMIN_IMG_URL; ?>title_bg2.jpg>您的相关信息</td>
    </tr>
  ...
  <table cellspacing=0 cellpadding=2 width="95%" align=center border=0>
    ...
    <tr>
      ...
      <td style="color: #880000">
        <a href="http://www.sshok.cn">www.sshok.cn</a>
      </td>
    </tr>
  </table>
</body>
