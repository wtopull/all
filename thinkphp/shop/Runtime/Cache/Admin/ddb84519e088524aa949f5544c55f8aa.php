...
<body>
  ...
  <div class="div_head"> <span>
                <span style="float: left;">当前位置是：商品管理-》商品列表</span> <span style="float: right; margin-right: 8px; font-weight: bold;">
                    <a style="text-decoration: none;" href="/shop/index.php/Admin/Goods/tianjia" target="_self">【添加商品】</a>
                </span> </span>
  </div>
  <div></div>
  <div class="div_search"> <span>
    ...
    <table class="table_a" border="1" width="100%">
      <tbody>
        ...
        <?php if(is_array($info)): foreach($info as $key=>$vo): ?><tr id="product1">
          ...
          <td>
            <a href="/shop/index.php/Admin/Goods/xiugai" target="right">修改</a>
          </td>
          <td>
        ...
        <tr id="product2">
          ...
          <td>
            <a href="javascript:;" onclick="delete_product(2)">删除</a>
          </td>
        </tr>
        <tr id="product3">
          <td>3</td>
          <td>
            <a href="#">苹果（APPLE）iPhone 4 8G版</a>
          </td>
          <td>100</td>
          <td>1290</td>
          ...
          <td>
            <a href="javascript:;" onclick="delete_product(3)">删除</a>
          </td>
        </tr>
        <tr id="product4">
          <td>4</td>
          <td>
            <a href="#">苹果（APPLE）iPhone 4S 16G版</a>
          </td>
          <td>100</td>
          <td>987</td>
